          ...
          <div className="col-lg-3 bg-dark d-none d-lg-block">
            ...
            >
              <img
                ...
                alt="Petheaven Logo"
                style={{ width: "85px", height: "80px", marginRight: "5px" }}
              />
          ...
          <div className="col-lg-9">
            <nav className="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
              ...
              >
                <div className="navbar-nav mr-auto py-0">
                  ...
                  {userData?.rol === "admin" ? (
                    <>
                      ...
                      <Link to="/admin/graficas" className="nav-item nav-link">
                        Dashboard Admin
                      </Link>
                      <Link to="/admin/usuarios" className="nav-item nav-link">
                        G Usuarios
                      </Link>
                    ...
                    <>
                      ...
                      >
                        ...
                        >
                          ...
                          <Link to="/ReservasActivas" className="dropdown-item">
                            Reservas Activas
                          </Link>
                ...
                {/* Icono de Instagram */}
                <a
                  href="https://www.instagram.com/petheaven.gt/"
                  target="_blank"
